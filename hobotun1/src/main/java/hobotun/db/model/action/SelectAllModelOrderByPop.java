...
public class SelectAllModelOrderByPop extends MappingSqlQuery<ModelTbl> {
	...
	private static final String SQL_SELECT_MODEL_BY_USER_ID = 
			...
			+ " ORDER by t.download DESC, t.idModel DESC";

	public SelectAllModelOrderByPop(DataSource dataSource) {
