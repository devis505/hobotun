...
public class CheckUserModel extends MappingSqlQuery<UserModelTbl>{
	
	private static final String SQL_SELECT_MODEL_BY_USER_ID = 
			  "SELECT * FROM hb_user_model u WHERE u.IdModel = :id_model AND u.idUser = :id_user  AND u.idEntityType = 2";

	public CheckUserModel(DataSource dataSource) {
